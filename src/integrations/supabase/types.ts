  ...
  public: {
    ...
    Enums: {
      ...
      case_type:
        ...
        | "PROBATE"
        | "TRAFFIC"
      document_visibility: "PARTIES_ONLY" | "COURT_ONLY" | "PUBLIC"
      filing_status: "SUBMITTED" | "UNDER_REVIEW" | "ACCEPTED" | "REJECTED"
      hearing_status: "SCHEDULED" | "RESCHEDULED" | "CANCELLED" | "HELD"
      participant_role:
        | "PLAINTIFF"
        | "DEFENDANT"
        | "ATTORNEY"
